...
> 論文 *《Classification-Head Bias in Class-Level Machine Unlearning: Diagnosis, Mitigation, and Evaluation》* 官方代碼
...
我們的實驗基於 Yichen 等人的代碼庫 ([CMF_Unlearning](https://github.com/ycgao1/CMF_Unlearning))。他們的代碼非常完善，包含許多對比實驗，我們直接在上面進行更改來完成我們的實驗。為了避免版權爭議，本程式碼倉庫僅提供了 Yichen 等人程式碼之外所需的核心程式碼。。接下來我們會手把手地告訴你如何複現我們的論文。
