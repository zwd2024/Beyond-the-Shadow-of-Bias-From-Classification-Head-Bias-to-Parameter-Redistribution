...
我们的实验基于 Yichen 等人的代码库 ([CMF_Unlearning](https://github.com/ycgao1/CMF_Unlearning))。他们的代码非常完善，包含许多对比实验，我们直接在上面进行更改来完成我们的实验。本代码仓库提供了 Yichen 等人代码之外所需的核心代码。接下来我们会手把手地告诉你如何复现我们的论文。
